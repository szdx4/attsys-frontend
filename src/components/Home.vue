<template>
  <section>
    ...
    <el-dialog v-model="editFormVisible" title="修改密码" :close-on-click-modal="false">
      <el-form ref="editForm" :model="editForm" label-width="80px">
        <el-form-item label="旧密码" prop="old_password">
          <el-input v-model="editForm.old_password" auto-complete="off" />
        </el-form-item>
        <el-form-item label="新密码" porp="new_password">
          <el-input v-model="editForm.new_password" auto-complete="off" />
        </el-form-item>
      </el-form>
