...
export const LeaveRequest = params =>{ return axios.post( `${base}/leave/user`, { params: params });}//申请请假
...
export const addDepartment = params => { return axios.post('/department',{ params:params });}//添加部门

export const editDepartment = params => { return axios.post('/department',{ params:params});}//编辑部门
