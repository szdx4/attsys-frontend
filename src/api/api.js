...
export const getLeaveListPage = params => {
    return axios.get(`${base}/leave`, {params: params});
};

//获取指定用户请假信息
export const getLeaveUser = (id, params) => {
    return axios.get(`${base}/leave/user/${id}`, {params: params})
};

//申请请假
export const LeaveRequest = (id, params) => {
    return axios.post(`${base}/leave/user/${id}`, {params: params});
};

//审核请假申请
export const LeaveRequestApproval = (id, params) => {
    return axios.put(`${base}/leave/user/${id}`, {params: params});
};
...
export const getOvertimeList = params => {
    return axios.get(`${base}/overtime`, {params: params});
};

//获取指定用户加班申请
export const getOvertimeUser = (id, params) => {
    return axios.get(`${base}/overtime/user/${id}`, {params: params});
};

//申请加班
export const OvertimeRequest = (id, params) => {
    return axios.post(`${base}/overtime/user/${id}`, {params: params});
};

//审核加班申请
export const OvertimeApproval = (id, params) => {
    return axios.put(`${base}/overtime/user/${id}`, {params: params});
};
...
export const getHours = params => {
    return axios.get(`${base}/hours`, {params: params});
};
...
export const addDepartment = params => {
    return axios.post(`${base}/department`, {params: params});
};

//编辑部门
export const editDepartment = (id, params) => {
    return axios.put(`${base}/department/${id}`, {params: params});
};

//获取指定部门信息
export const getDepartment = (id, params) => {
    return axios.get(`${base}/department/${id}`, {params: params});
};

//删除部门
export const deletDepartment = (id, params) => {
    return axios.delete(`${base}/department/${id}`, {params: params})
};
...
export const getFaceUser = (id, params) => {
    return axios.get(`${base}/face/user/${id}`, {params: params});
};

//更新指定用户人脸信息
export const editFaceUser = (id, params) => {
    return axios.post(`${base}/face/user/${id}`, {params: params});
};

//审核人脸信息
export const faceApproval = (id, params) => {
    return axios.put(`${base}/face/user/${id}`, {params: params});
};

export const getFaceList = (id, params) => {
    return axios.get(`${base}/face`, {params: params});
}
...
export const getShiftList = params => {
    return axios.get(`${base}/shift`, {params: params});
};

//添加排班
export const addShift = (id, params) => {
    return axios.post(`${base}/shift/user/${id}`, {params: params});
};

//添加部门排班
export const addDepartmentShift = params => {
    return axios.get(`${base}/shift/department`, {params: params});
};

//删除排班
export const deletShift = params => {
    return axios.post(`${base}/shift/${id}`, {params: params});
};
...
export const getSignStatus = (id, params) => {
    return axios.get(`${base}/sign/user/${id}`, {params: params});
};

//获取二维码
export const getSignQrcode = params => {
    return axios.get(`${base}/sign/qrcode`, {params: params});
};

//二维码签到
export const signQrcode = (id, params) => {
    return axios.post(`${base}/sign/qrcode/user/${id}`, {params: params});
};
